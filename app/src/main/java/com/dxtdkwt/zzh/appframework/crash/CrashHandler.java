package com.dxtdkwt.zzh.appframework.crash;
...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    /**
     * 这个是最关键的函数，当程序中有未被捕获当异常，系统将会自动调用#uncaughtException方法
     * thread为出现未捕获异常当线程，ex为未捕获当异常，有个这个ex，我们就可以得到异常信息
     *
     * @param thread
     * @param ex
     */
    ...
    public void uncaughtException(@NonNull Thread thread, @NonNull Throwable ex) {
        ...
        ex.printStackTrace();
        //如果系统提供了默认到异常处理器，则交给系统去结束程序，否则就由自己结束自己
