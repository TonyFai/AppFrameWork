package com.dxtdkwt.zzh.appframework.ui.fragment;
...
//            dispatchChildVisibleState(false);
    ...
    private boolean isParentInvisible() {
        ...
        if (parentFragment instanceof LazyLoadingFragment) {
            LazyLoadingFragment fragment = (LazyLoadingFragment)parentFragment;
    ...
    private void dispatchChildVisibleState(boolean visible) {
        ...
        if (fragments != null) {
            for (Fragment fragment: fragments) {
                if (fragment instanceof LazyLoadingFragment &&
                        !fragment.isHidden() &&
                        fragment.getUserVisibleHint()) {
                    ((LazyLoadingFragment)fragment).dispatchUserVisibleHint(visible);
                }
            }
        }
    }
