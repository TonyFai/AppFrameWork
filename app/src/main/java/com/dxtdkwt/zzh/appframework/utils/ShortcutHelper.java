...
import com.dxtdkwt.zzh.appframework.ui.activity.ShortcutActivity;
...
public class ShortcutHelper {
    private static final String TAG = ShortcutActivity.TAG;
    ...
    private void callShortcutManager(BooleanSupplier r) {
        try {
            if (!r.getAsBoolean()) {
                ToastUtils.showShort( "Call to ShortcutManager is rate-limited");
            }
        } catch (Exception e) {
            Log.e(TAG, "Caught Exception", e);
            ToastUtils.showShort(  "Error while calling ShortcutManager: " + e.toString());
        }
    }
    ...
    private ShortcutInfo.Builder setSiteInformation(ShortcutInfo.Builder b, Uri uri) {
        ...
        if (bmp != null) {
            ...
            b.setIcon(Icon.createWithResource(mContext, R.drawable.custom_progress_dialog_bg));
        }
