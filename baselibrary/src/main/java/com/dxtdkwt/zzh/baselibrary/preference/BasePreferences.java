package com.dxtdkwt.zzh.baselibrary.preference;
...
import com.dxtdkwt.zzh.baselibrary.utils.EditorUtils;
import com.dxtdkwt.zzh.baselibrary.utils.EmptyUtils;
...
abstract class BasePreferences {
    ...
    public BasePreferences() {
        if (EmptyUtils.isEmpty(getSPFileName())) {
