    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && NetworkApp.getApp().getExternalCacheDir() != null) {
                sDefaultDir = NetworkApp.getApp().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            } else {
                sDefaultDir = NetworkApp.getApp().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
